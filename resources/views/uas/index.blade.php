...
<div style="width:200px; background: linear-gradient(#d4c3ca,#fea3d0); padding:15px;">
    ...
    <p><a href="/data">Data Pendaftar</a></p>
...
<tr>
    ...
    <td>:</td>
    <td>
        <input type="radio" name="sekolah_asal" value="SMA"> SMA
        <input type="radio" name="sekolah_asal" value="MA"> MA
        <input type="radio" name="sekolah_asal" value="SMK"> SMK
    </td>
</tr>
...
<tr>
    ...
    <td>:</td>
    <td>
        <input type="text" name="nilai_mtk" style="width:100%; padding:8px;">
    </td>
</tr>
...
<tr>
    ...
    <td>:</td>
    <td>
        <input type="text" name="nilai_binggris" style="width:100%; padding:8px;">
    </td>
</tr>
...
<tr>
    ...
    <td>:</td>
    <td>
        <input type="text" name="nilai_bindo" style="width:100%; padding:8px;">
    </td>
</tr>
...
<tr>
    ...
    <td>:</td>
    <td>
        <select name="jurusan1" style="width:100%; padding:8px;">
...
<tr>
    ...
    <td>:</td>
    <td>
        <select name="jurusan2" style="width:100%; padding:8px;">
            <option>TEKNIK INFORMATIKA</option>
            <option>SISTEM INFORMASI</option>
        </select>
    </td>
